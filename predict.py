...
if __name__ == '__main__':
    ...
    prediction_output_file = os.path.join(output_dir, 'prediction_no_mask_and_literal.csv')
    ...
    ds = datasets.load_dataset(script_path, data_files=data_files, split='test[:20%]')
    ...
    for sent_id, group in df.groupby('sent_id'):
        ...
        literal_frames = group['mask_frames'].values
